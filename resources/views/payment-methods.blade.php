                ...
                <div class="container mt-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" style="text-align:right;">
                            <a class="btn btn-success" href="{{ route('payments.create') }}"> Create Payment Method</a>
                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('payments.destroy',$payment_method->id) }}" method="Post">
                                        <a class="btn btn-primary" href="{{ route('payments.edit',$payment_method->id) }}"><i class="fa-solid fa-pen-to-square"></i></a>
                                        @csrf
                                        @method('DELETE')
